    ...
    <section className="section-mv">
        <div className="section-mv__inner">
            <div className="section-mv__left">
                <p className="section-mv__hi">Hey there! My name is</p>
                <h1 className='section-mv__ttl c-ttl-gradient-01'>Vinh Tieng</h1>
                {/* <h2 className='section-mv__lead'>I am a Front end Developer</h2> */}
                <p className='c-txt u-t-j'>I work as a <a href="" className="c-link">Front-end developer</a> right here in <a href="https://goo.gl/maps/6ZQEUhHLXKZ4JBMN6" target='_blank' className="c-link">Ho Chi Minh City, Vietnam.</a></p>
